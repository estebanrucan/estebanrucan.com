      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="mb-8 sm:mb-12 flex items-center justify-center">
            <div
              className="
                ...
                justify-center rounded-full bg-indigo-100 dark:bg-indigo-900
                shadow-lg
              "
            >
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <TiltCard className="glassmorphic overflow-hidden rounded-xl p-4 sm:p-6 shadow-lg">
              <motion.div
              ...
              >
                <div
                  className="
                    ...
                    rounded-full bg-blue-100 dark:bg-blue-900/50
                  "
                >
                ...
                <a
                  ...
                  className="
                    group relative mt-2 inline-flex items-center 
                    rounded-full bg-blue-100 px-6 py-2 font-medium 
                    text-blue-700 transition-all duration-300 hover:scale-105 
            ...
            <TiltCard className="glassmorphic overflow-hidden rounded-xl p-4 sm:p-6 shadow-lg">
              ...
              >
                ...
                <a
                  ...
                  className="
                    group relative mt-2 inline-flex items-center 
                    rounded-full bg-gray-100 px-6 py-2 font-medium 
                    text-gray-800 transition-all duration-300 hover:scale-105 
