        ...
        >
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {education.map((edu, index) => (
              <TiltCard
                key={index}
                className="group overflow-hidden rounded-xl bg-white shadow-lg transition-all duration-300 hover:shadow-xl dark:bg-gray-800"
                glareOpacity={0.1}
                tiltAmount={5}
              >
                <motion.div
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="mb-1 text-gray-700 dark:text-gray-300">{edu.institution}</p>
          ...
          >
            <TiltCard className="overflow-hidden rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800">
              <div className="mb-4 flex items-center">
                <div className="mr-4 flex h-10 w-10 items-center justify-center rounded-full bg-yellow-100 dark:bg-yellow-900">
                  <span className="text-lg font-bold text-yellow-600 dark:text-yellow-300">🏆</span>
                </div>
                <h3 className="text-xl font-bold">{t("education.awards.title")}</h3>
              </div>

              <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-900/50">
                <h4 className="mb-1 font-semibold">{t("education.awards.name")}</h4>
                <p className="text-gray-700 dark:text-gray-300">{t("education.awards.description")}</p>
              </div>
            </TiltCard>
          </motion.div>
        </motion.div>
